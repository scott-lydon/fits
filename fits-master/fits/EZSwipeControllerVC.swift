...
//Setting the middle b
       ...
       let imageView = UIImageView(image: #imageLiteral(resourceName: "illgourmet"))
        ...
        if index == 0 {
            ...
            //Right
             let rImage = scaleTo(image: #imageLiteral(resourceName: "ill_tiny_nav_icon"), w: 22, h: 22)
            let rightButtonItem = UIBarButtonItem(image: rImage, style: UIBarButtonItemStyle.plain, target: self, action: nil)
            ...
            //Left
            let lImage = scaleTo(image: #imageLiteral(resourceName: "profile_icon"), w: 22, h: 22)
            let leftButtonItem = UIBarButtonItem(image: lImage, style: UIBarButtonItemStyle.plain, target: self, action: nil)
            leftButtonItem.tintColor = illGray
            navigationItem.leftBarButtonItem = leftButtonItem
            
            //Right
            let rImage = scaleTo(image: #imageLiteral(resourceName: "cart_icon"), w: 22, h: 22)
            let rightButtonItem = UIBarButtonItem(image: rImage, style: UIBarButtonItemStyle.plain, target: self, action: nil)
            ...
            let lImage = scaleTo(image: #imageLiteral(resourceName: "ill_tiny_nav_icon"), w: 22, h: 22)
            let leftButtonItem = UIBarButtonItem(image: lImage, style: UIBarButtonItemStyle.done, target: self, action: nil)
            leftButtonItem.tintColor = illOrange
            navigationItem.leftBarButtonItem = leftButtonItem
